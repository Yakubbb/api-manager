...
export default function () {
    return (
        <div className="flex flex-row w-[100%] h-[100%] gap-2 p-4">
            <div className="flex flex-col gap-2 rounded-xl w-[50%] h-[100%] bg-[#ffffff] p-4 shadow-[0_3px_10px_rgb(0,0,0,0.1)]">
