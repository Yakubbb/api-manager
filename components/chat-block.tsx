...
export function ChatBlock({
    ...
    return (
        <div className=" flex flex-col w-9/12 max-h-5/6 shrink-0 ">
            ...
            <div className="pt-5 gap-10 w-full">
                <div className="flex justify-between text-white bg-slate-900  border border-blue-500 rounded-3xl p-4  shadow-2xl shadow-indigo-600/20">
